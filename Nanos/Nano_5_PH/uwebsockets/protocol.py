...
class Websocket:
    ...
    def read_frame(self, max_size=None):
        ...
        try:
            ...
            # Frame too big, close the connection
            simple_log("Frame of length %s too big. Closing", length)
    ...
    def write_frame(self, opcode, data=b''):
        ...
        if length < 126:  # 126 is the magic value to use a 2-byte length header
            byte2 |= length
        ...
        elif length < (1 << 64):  # Length fits in 8 bytes
    ...
    def recv(self):
        ...
        while self.open:
            try:
                ...
                simple_log("Failed to read frame. Socket dead.")
                self._close()
